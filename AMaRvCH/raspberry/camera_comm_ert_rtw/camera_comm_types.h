...
#ifndef RTW_HEADER_camera_comm_types_h_
#define RTW_HEADER_camera_comm_types_h_
#include "rtwtypes.h"
#include "multiword_types.h"
#ifndef typedef_cell_wrap_camera_comm_T
#define typedef_cell_wrap_camera_comm_T

typedef struct {
  uint32_T f1[8];
} cell_wrap_camera_comm_T;

#endif                                 /*typedef_cell_wrap_camera_comm_T*/
...
#ifndef typedef_dsp_MedianFilter_camera_comm_T
#define typedef_dsp_MedianFilter_camera_comm_T

typedef struct {
  boolean_T matlabCodegenIsDeleted;
  int32_T isInitialized;
  boolean_T isSetupComplete;
  cell_wrap_camera_comm_T inputVarSize;
  int32_T NumChannels;
  dsp_private_MedianFilterCG_ca_T pMID;
} dsp_MedianFilter_camera_comm_T;

#endif                                 /*typedef_dsp_MedianFilter_camera_comm_T*/
...
typedef struct P_camera_comm_T_ P_camera_comm_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_camera_comm_T RT_MODEL_camera_comm_T;

#endif                                 /* RTW_HEADER_camera_comm_types_h_ */
