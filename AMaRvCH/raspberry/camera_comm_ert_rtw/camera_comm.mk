###########################################################################
## Makefile generated for Simulink model 'camera_comm'. 
## 
## Makefile     : camera_comm.mk
## Generated on : Thu Nov 29 08:50:15 2018
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/camera_comm.elf
...
MODELREF_LINK_RSPFILE_NAME = camera_comm_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/camera_comm.elf
...
DEFINES_STANDARD = -DMODEL=camera_comm -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = MW_gpio.c MW_SDL_video_display.c v4l2_capture.c v4l2_capture_linux.c camera_comm.c camera_comm_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c ext_svr.c updown.c ext_work.c rtiostream_utils.c linuxinitialize.c rtiostream_interface.c rtiostream_tcpip.c
...
OBJS = MW_gpio.c.o MW_SDL_video_display.c.o v4l2_capture.c.o v4l2_capture_linux.c.o camera_comm.c.o camera_comm_data.c.o rtGetInf.c.o rtGetNaN.c.o rt_nonfinite.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o
